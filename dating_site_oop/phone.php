...
<body>
    ...
    <div class="special my-5">
        <h2 class="text-center">Filter By Phone</h2>
        <form action="phone.php" method="POST" class="d-flex justify-content-center">
        ...
        <div class="container">
            <div class="row py-5 justify-content-evenly border border-black">
                ...
                <?php foreach ($result as $row) : ?>
                    <form action="phone.php" method="POST" class="col-lg-3 ">
                        <div class="card my-2">
                            ...
                            <p class="mx-2"><small><span name="tharga"><?= $row["phone_number"]; ?></span></small></p>
                        </div>
                    </form>
