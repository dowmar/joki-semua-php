            ...
            <div class="row py-5 justify-content-evenly border border-black">
                ...
                <?php foreach ($result as $row) : ?>
                    ...
                    <form action="menupdo.php" method="POST" class="col-lg-3 ">
                        <div class="card my-2">
                            <!-- Popup tampilan profile, akan muncul ketika di klik gambar -->
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-centered" id="profile">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a id="liked" class="btn-like" href="wishdelete.php?phone_number=<?= $row["phone_number"]; ?> ">
                                                <i class="fa-regular fa-trash-can fa-2x mx-3"></i>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <p class="mx-2"><small><span name="tusername"><?= $row["username"]; ?></span></small></p>
