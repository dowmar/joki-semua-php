        ...
        <center>
            ...
            <form action="#" method="post">
                ...
                <div id="divback" style="background:url(../images/bisaat.png); background-repeat:no-repeat; background-size:auto; background-position:center; height:400px; width:360px;">
                    <div id="tictac-div" class="div1" style="margin-left:0; background:url(); background-repeat:no-repeat; background-size:contain; background-position:center;border:2px solid pink"> </div>
