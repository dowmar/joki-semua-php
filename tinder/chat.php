...
if (isset($_SESSION['username'])) {
	...
	include 'app/handler/user.php';
	include 'app/handler/chat.php';
	include 'app/handler/opened.php';

	include 'app/handler/timeAgo.php';
			...
			$(document).ready(function() {
				...
				**/
				let lastSeenUpdate = function() {
					$.get("service/update_last_seen.php");
				}
				lastSeenUpdate();
				/** 
				auto update last seen 
